...
#============================================
def test_task_owned_patterns_prune_unmatched_source_and_derivatives(tmp_path: pathlib.Path) -> None:
	"""Current CSV ownership removes only the unmatched BBQ source family."""
	topic_folder = tmp_path / "site_docs/genetics/topic01"
	downloads_dir = topic_folder / "downloads"
	downloads_dir.mkdir(parents=True)
	owned_source = topic_folder / "bbq-owned-questions.txt"
