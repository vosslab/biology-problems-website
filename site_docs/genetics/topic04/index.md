...
## Mendelian Crosses and Generations (Matching)
...
## Mendelian Genetics Terms (Matching)
...
## Parental Genotypes in Monohybrid Crosses (Matching)
...
## Mendelian Crosses and Generations (Multiple Choice)
...
## Mendel's Principles (Multiple Choice)
...
## Mendelian Genetics Terms (Multiple Choice)
...
## Parental Genotypes in Monohybrid Crosses (Multiple Choice)
...
## Choosing Punnett Squares for Flower Color Crosses
...
## Identifying Inheritance Patterns from Pedigree Diagrams
...
<button class="md-button custom-button human_read" onclick="window.open('downloads/human_readable-write_pedigree_choice.html', '_blank')" title="View human_readable-write_pedigree_choice.html" aria-label="Click to view the Human-Readable TXT file (human_readable-write_pedigree_choice.html)">
    <i class="fa fa-eye"></i> Human-Readable TXT
</button>
</div><details>
  <summary>Click
  ...
  {% include "genetics/topic04/downloads/selftest-write_pedigree_choice.html" %}
...
<button class="md-button custom-button human_read" onclick="window.open('downloads/human_readable-write_pedigree_match.html', '_blank')" title="View human_readable-write_pedigree_match.html" aria-label="Click to view the Human-Readable TXT file (human_readable-write_pedigree_match.html)">
    <i class="fa fa-eye"></i> Human-Readable TXT
</button>
</div><details>
  <summary>Click
  ...
  {% include "genetics/topic04/downloads/selftest-write_pedigree_match.html" %}
...
<button class="md-button custom-button human_read" onclick="window.open('downloads/human_readable-write_pedigree_match_random.html', '_blank')" title="View human_readable-write_pedigree_match_random.html" aria-label="Click to view the Human-Readable TXT file (human_readable-write_pedigree_match_random.html)">
    <i class="fa fa-eye"></i> Human-Readable TXT
</button>
</div><details>
  <summary>Click
  ...
  {% include "genetics/topic04/downloads/selftest-write_pedigree_match_random.html" %}
