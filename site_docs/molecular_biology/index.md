...
7. [Translation](topic09/index.md) <span class='topic-count' title='5 questions'>5 questions</span>
    - Translation of mRNA into protein, codons, anticodons, genetic code, ribosomes, tRNA, and peptide synthesis.

8. [Historical Experiments](topic10/index.md) <span class='topic-count' title='2 questions'>2 questions</span>
